...
def main():
    ...
    # Train the model
    history = train_model(loaded_model, train_dir, valid_loader, device, metrics_handler, BATCH_SIZE, train_transform, early_stopping_patience=5, lr=0.0005, epochs=10)
