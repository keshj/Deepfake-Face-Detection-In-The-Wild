...
def main():
    ...
    load_model(loaded_model, "/home/nithira/sp_cup/saved_states/combined_model_20250113_183657.pth", device)

    # Train the model
    history = train_model(loaded_model, train_dir, valid_loader, device, metrics_handler, BATCH_SIZE, train_transform, early_stopping_patience=5, lr=0.0001, epochs=10)
